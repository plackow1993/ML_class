...
if chi_2 > chi_crit:
    print('Chi is right of the critical value so this test is a pass, keep the split (p<ALPHA)')
else:
    print('Chi is left of the critical value so this test is a fail, stop splitting here (p>ALPHA)')
